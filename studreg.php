...
<html>
     ...
     <form action="studregadd.php" method="POST">
          <center>
           <table border="1">
                 <h1>Student Registration</H1>
                 <tr><td>Roll no</td><td><input type="text" name=ro required></td></tr>
                 ...
                 <tr><td>Class</td><td><Select name="c"required>
<option selected="true">Select</option>
<option value="SE" >SE</option>
<option value="TE" >TE</option>
<option value="BE" >BE</option></td></tr>
